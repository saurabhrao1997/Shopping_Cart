...
<div className='min-w-[120px] h-full pt-10 fixed top-0 left-0  bg-gray-600  px-1'>
 ...
 { isAdmin &&  <li className='w-full hover:bg-gray-700  py-2'>  <NavLink to={"/create"} className={({isActive})=>{ return `text-white ${isActive ? "text-white drop-shadow-lg  shadow-white  font-bold " :" text-gray-200"}` }}>CreateProduct</NavLink></li>}
 {isAdmin &&   <li className='w-full hover:bg-gray-700  py-2'>  <NavLink to={"/users"} className={({isActive})=>{ return `text-white ${isActive ? "text-white drop-shadow-lg  shadow-white  font-bold " :" text-gray-200"}` }}>Users</NavLink></li>}
   {isAdmin && <li className='w-full hover:bg-gray-700  py-2'>  <NavLink to={"/category"} className={({isActive})=>{ return `text-white ${isActive ? "text-white drop-shadow-lg  shadow-white  font-bold " :" text-gray-200"}` }}>Category</NavLink></li>}
